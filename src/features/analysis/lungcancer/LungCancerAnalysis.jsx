...
// TODO (Lung Cancer owner): uncomment when your backend is ready
...
export default function LungCancerAnalysis({ navigate }) {
  ...
  async function run() {
    ...
    try {
      ...
      // setResult(await predictLungCancer(patientId, file));
      setError("Lung Cancer backend is not connected yet.");
  ...
  return (
    ...
    >
      ...
      <ScanUploader preview={preview} onFile={onFile} onClear={clearFile} hint="PNG · JPG · DICOM" />
    </AnalysisLayout>
  );
}
